<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="#" class="site_title"><i class="fa fa-leaf"></i> <span></span></a>
        </div>
                ...
                <ul class="nav side-menu">
                    <li>
                    	<a href="<?= site_url('profil');?>">
                            <i class="fa fa-laptop"></i> Profil
                    		<!-- <i class="fa fa-laptop"></i> Dashboard <span class="label label-success pull-right"> </span> -->
                    	</a>
                    </li>
                
                    <!-- <li><a><i class="fa fa-table"></i> Seting<span class="fa fa-chevron-down"></span></a>
